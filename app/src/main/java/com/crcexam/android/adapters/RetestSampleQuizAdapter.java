...
public class RetestSampleQuizAdapter extends RecyclerView.Adapter<RetestSampleQuizAdapter.MyViewHolder> {
    ...
    public RetestSampleQuizAdapter(Context mContext, ArrayList<JSONObject> testList, RecyclerViewClickWithJson mRvListener) {
            ...
            if (!testList.get(position).has("is_refresh")) {
                holder.itemViewSelected.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        mRvListener.onItemClick(holder.itemViewSelected, position, testList.toString(),testList.get(position));
                    }
                });
            } else {
